    ...
    return GestureDetector(
      ...
      child: SizedBox(
        ...
        child: AnimatedBuilder(
          animation: Listenable.merge([_spin, _pulse, _energy]),
          builder: (context, _) {
            // энергия: до окончания контроллера 1→0, дальше держим 0.35
            final raw = widget.connected ? (1 - _energy.value) : 0.0;
                    ...
                    children: [
                      if (widget.busy)
                        ...
                        Icon(Icons.power_settings_new_rounded,
                            size: 40,
                            color: widget.connected ? P.limeText : P.textFaint),
